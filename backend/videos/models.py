...
class File(models.Model):
    """ファイルモデル"""
    file_name = models.CharField(max_length=500, verbose_name='ファイル名')
    file_path = models.CharField(max_length=1000, unique=True, verbose_name='ファイルパス')
    ...
    thumbnail_file_path = models.CharField(max_length=1000, null=True, blank=True, verbose_name='サムネイルGIFパス')
...
class ScanHistory(models.Model):
    ...
    message = models.TextField(blank=True, null=True)  # エラー内容やログ用
